...
before packages are loaded."
  ...
  (define-key evil-normal-state-map (kbd "C-k") (kbd "3gk"))
  (define-key evil-normal-state-map (kbd "C-j") (kbd "3gj"))
